...
- **Groq**: A platform that offers fast inference for open-source LLMs. Here, it is used to run the `openai/gpt-oss-120b` reasoning model and the `llama-4-scout-17b-16e-instruct` vision model.
